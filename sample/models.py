...
class Sample(models.Model):
    ...
    crop_name = models.CharField(max_length=100, verbose_name="اسم المحصول والصنف")
    distinguishing_marks = models.CharField(max_length=200,null=True, blank=True, verbose_name="رقم الأرسالية ")
    sample_id = models.CharField(max_length=100, unique=True, verbose_name="رقم العينة (الرقم المختبري)")
