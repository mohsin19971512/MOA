...
from . import views
from .Health.views import HealthTestDetailView, update_health_test
...
urlpatterns = [
    ...
    path('update_plant_test/<int:assignment_id>/', views.update_plant_test, name='update_plant_test'),
